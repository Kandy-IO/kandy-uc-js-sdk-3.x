...
-   `options` **[Object][5]?** Call options.
    ...
    -   `options.customParameters` **[Array][8]&lt;{name: [string][2], value: [string][2]}>?** Custom SIP header parameters for the SIP backend.
...
Returns **[Array][8]&lt;{name: [string][2], value: [string][2]}>** Custom parameters of the call.
...
-   `callId` **[string][2]** The ID of the call being acted on.
-   `customParameters` **[Array][8]&lt;{name: [string][2], value: [string][2]}>** Custom parameters for the call.
...
-   `user` **([Array][8]&lt;[string][2]> | [string][2])** A User ID or an array of User IDs.

Returns **([Array][8]&lt;[Object][5]> | [Object][5])** List of user presence information.

### getAll

Retrieves the presence information for all available users.

Returns **[Array][8]&lt;[Object][5]>** List of user presence information.
...
Returns **[Array][8]&lt;[User][27]>** An array of all the User objects.
...
-   `options` **[Object][5]?** Sorting options.
    ...
    -   `options.max` **[number][6]?** The maximum number of results to return.
